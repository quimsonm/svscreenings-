...
export const services: Service[] = [
  ...
  {
    slug: 'abdomen-complete',
    title: 'Abdomen Complete Ultrasound',
    shortTitle: 'Abdomen Complete',
    icon: 'abdomen',
    shortDescription: 'Ultrasound of the liver, gallbladder, kidneys, spleen, and pancreas — a comprehensive look at your abdominal organs.',
    whatItIs: 'A non-invasive ultrasound scan of the major abdominal organs including liver, gallbladder, kidneys, spleen, and pancreas.',
    whyItMatters: 'Many abdominal conditions — fatty liver disease, gallstones, kidney cysts, and more — develop silently. Early detection allows for monitoring and treatment before symptoms appear.',
    whoShouldGet: [
      'Anyone with persistent abdominal discomfort or bloating',
      'Those with a family history of liver or kidney disease',
      'People with elevated liver enzymes on bloodwork',
      'Adults over 45 wanting a comprehensive baseline',
    ],
    whatToExpect: 'A painless scan of the abdomen taking approximately 20–30 minutes. You may be asked to fast for 4–6 hours beforehand for optimal imaging of the gallbladder.',
    includedIn: ['The Gold Standard'],
  },
  {
    slug: 'thyroid',
    ...
    shortTitle: 'Thyroid',
    icon: 'thyroid',
    shortDescription: 'Ultrasound of the thyroid gland to evaluate size, structure, and detect nodules or abnormalities.',
    whatItIs: 'A non-invasive ultrasound of the thyroid gland in the front of your neck.',
    whyItMatters: 'Thyroid nodules are extremely common and usually benign, but imaging is the only way to evaluate them. Early identification allows your doctor to monitor or investigate further as needed.',
    whoShouldGet: [
      'Anyone with a known or suspected thyroid nodule',
      'Those with thyroid symptoms (fatigue, weight changes, neck swelling)',
      'Family history of thyroid disease or cancer',
      'Adults wanting a comprehensive wellness baseline',
    ],
    whatToExpect: 'A quick, painless scan of the neck taking approximately 15–20 minutes. No prep required.',
    includedIn: ['The Gold Standard'],
  },
];
